...
export default function App() {
  ...
  const remoteSlide = (agent as unknown as { state?: SlideState }).state?.currentSlide ?? 0
  ...
  return (
    <div className="relative flex h-screen w-screen flex-col bg-background-200">
      {/* Slide area */}
      <div className={`flex-1 min-h-0 p-6 md:p-12 ${isFullscreen ? "pb-6 md:pb-12" : "pb-3 md:pb-3"}`}>
      ...
      <div className={`relative flex shrink-0 items-center justify-center px-6 pt-2 pb-4 md:px-12 transition-opacity duration-300 ${isFullscreen ? "opacity-0 pointer-events-none h-0 overflow-hidden p-0" : ""}`}>
